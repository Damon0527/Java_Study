package _05_class._interface._03;
...
public class InterfaceEx03 {
    public static void main(String[] args) {
        ...
        sp.makeCall("010-1234-353");
        sp.answerCall();

        sp.browseWeb("www.example.com");
        sp.sendEmail("test@exampe.com", "ㅎㅇ!");
...
/*
    추상 클래스 vs. 인터페이스
    # 추상 클래스
    - 클래스 내 추상 메소드가 하나 이상 포함 or abstract 로 정의 된 경우.

    # 인터페이스
    - 모든 메소드가 추상 메소드인 경우

    ## 공통점
    - 상속 받는 클래스 or 구현하는 인터페이스 안에 있는 "추상 메소드 구현 강제화"

    ## 차이점
    - 추상 클래스 : 추상 클래스를 상속 받아 기능을 이용하고 "확장"하는 것.
    - 인터페이스 : 함수 껍데기만 존재. 함수 구현 강제화 -> 구현 객체들의 "같은 동작을 보장"
